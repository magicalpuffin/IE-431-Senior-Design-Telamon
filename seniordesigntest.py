...
# ----
# Beginning debug of packing function
SO_high_quantities = SO_quantities[SO_quantities > 50]
indexed_df_low_quant = indexed_df.drop(SO_high_quantities.index.values)
indexed_df_low_quant

# Computationally this can start to take a long time, this ran within 2 mins
indexed_df_low_quant_packed_debug = indexed_df_low_quant.groupby(level = 0).apply(pack_SO)
indexed_df_low_quant_packed = indexed_df_low_quant_packed_debug[['Pack Status', 'Bin Name', 'Volume Difference', 'Weight Difference']]

output_df_3 = [indexed_df_low_quant, indexed_df_low_quant_packed, indexed_df_low_quant_packed_debug]
